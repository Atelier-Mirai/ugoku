...
particlesJS("pt1", {
  "particles": {
    ...
    "move": {
      "enable": true,
      "speed": 3,
      /*この数値を小さくするとゆっくりな動きになる*/ "direction": "bottom",
      /*下に向かって落ちる*/ "random": true,
      /*動きはランダム*/ "straight": false,
...
particlesJS("pt3", {
  "particles": {
    ...
    "move": {
      "enable": true,
      "speed": 7,
      /*この数値を小さくするとゆっくりな動きになる*/ "direction": "bottom-right",
      /*右下に向かって落ちる*/ "random": false,
