...
/*===========================================================*/
//SVGの初期設定
let logoVivus1; //1つめのSVG設定
let logoVivus2; //2つめのSVG設定
let logoVivus3; //3つめのSVG設定
//1～3のSVG初期設定
function VivusInit() {
  //1つめのSVG初期設定
...
function VivusAnime() {
  ...
  let elemPos = $('#logo').offset().top - 50; //要素より、50px上の位置まで来たら出現
  let scroll = $(window).scrollTop();
  let windowHeight = $(window).height();
  if (scroll >= elemPos - windowHeight) {
  ...
  let elemPos = $('#logo2').offset().top - 50; //要素より、50px上の位置まで来たら出現
  let scroll = $(window).scrollTop();
  let windowHeight = $(window).height();
  if (scroll >= elemPos - windowHeight) {
  ...
  let elemPos = $('#logo3').offset().top - 50; //要素より、50px上の位置まで来たら出現
  let scroll = $(window).scrollTop();
  let windowHeight = $(window).height();
  if (scroll >= elemPos - windowHeight) {
